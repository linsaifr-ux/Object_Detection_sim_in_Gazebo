...
def generate_launch_description():
    ...
    # Bridge non-image topics (cmd_vel, clock)
    gz_bridge = Node(
    ...
    # Dedicated image bridge for camera (handles encoding conversion correctly)
    ...
    return LaunchDescription([
        ...
        TimerAction(period=5.0, actions=[flight_controller]),
        TimerAction(period=6.0, actions=[yolo_detector]),
        TimerAction(period=7.0, actions=[visualizer]),
    ])
